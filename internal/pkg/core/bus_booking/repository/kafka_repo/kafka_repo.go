...
func New(customSyncProducer sarama.SyncProducer, topic string) repoPkg.Interface {
	return &repo{
...
func (r *repo) List(ctx context.Context, offset uint, limit uint) ([]models.BusBooking, error) {
	log.Error("kafka_repo::List not implemented method")
	return nil, repoPkg.ErrRepoNotImplementedMethod
}
...
func (r *repo) Add(ctx context.Context, bb models.BusBooking) (uint, error) {
	...
	if err != nil {
		log.Errorf("kafka_repo::Add error %s", err.Error())
		return 0, err
	}
	return 0, nil // TODO
}
...
func (r *repo) Get(ctx context.Context, id uint) (*models.BusBooking, error) {
	log.Error("kafka_repo::Get not implemented method")
	return nil, repoPkg.ErrRepoNotImplementedMethod
}
...
func (r *repo) ChangeSeat(ctx context.Context, id uint, newSeat uint) error {
	...
	if err != nil {
		log.Errorf("kafka_repo::ChangeSeat error %s", err.Error())
		return err
	}
	return nil // TODO
}
...
func (r *repo) ChangeDateSeat(ctx context.Context, id uint, newDate string, newSeat uint) error {
	...
	if err != nil {
		log.Errorf("kafka_repo::ChangeDateSeat error %s", err.Error())
		return err
	}
	return nil // TODO
}
...
func (r *repo) Delete(ctx context.Context, id uint) error {
	...
	if err != nil {
		log.Errorf("kafka_repo::Delete error %s", err.Error())
		return err
	}
	return nil // TODO
}
